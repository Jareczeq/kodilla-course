...
class BoardTestSuite {
    ...
    @Test
    void testAddTaskLinkFindUsersTasks() {
        //Given
        Board project = prepareTestData();
    ...
    void testAddTaskListAverageWorkingOnTask() {
        ...
        var average = project.getTaskLists().stream()
                ...
                .flatMap(tl -> tl.getTasks().stream())
                .map(Task::getCreated)
                .flatMapToInt(localDate -> IntStream.of((int) ChronoUnit.DAYS.between(localDate, LocalDate.now())))
                .average();

        //Then
        assertEquals(OptionalDouble.of(10), average);
    }
